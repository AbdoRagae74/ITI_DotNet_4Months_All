namespace LINQR3DotNetMNFD02
{
    public class Repository
    {
        ...
        public static List<Employee> GetEmployees()
        {
            ...
            {
                new Employee { Id = 1, Name = "Ahmed", Age = 26 , Salary = 1234, DeptId = 1}, //0
                new Employee { Id = 2, Name = "Mohamed", Age = 36 , Salary = 2234, DeptId = 2},// 1
                new Employee { Id = 3, Name = "Sara", Age = 46 , Salary = 4234, DeptId = 3}, //2
